    ...
    try:
        ...
        with tab_scatter:
            ...
            if not plot_df.empty:
                ...
                fig.add_annotation(x=1, y=100, xref="paper", yref="y", text="<b>🎯 Target: 100%</b>", showarrow=False, xanchor="right", font=dict(color="red", size=16))
